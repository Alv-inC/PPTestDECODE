...
@Configurable
@Autonomous(name = "[NEW]backupBETTERBlue", group = "Tests")
public class betterBlue extends OpMode {
    ...
    public void buildPaths() {
        switchHit = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(12.430, 59.710),
                                new Pose(19.631, 67.579),
                                new Pose(14.748, 69.449)
                        )
    ...
    public void autonomousPathUpdate() {
        ...
        switch (pathState) {
            ...
            case 100:
                if (!follower.isBusy()) {
                    follower.followPath(switchHit, true);
                    setPathState(7);
                }
