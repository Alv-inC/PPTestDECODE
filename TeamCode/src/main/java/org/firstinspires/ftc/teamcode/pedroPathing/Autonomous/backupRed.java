...
@Configurable
@Autonomous(name = "[NEW]backupRed", group = "Tests")
public class backupRed extends OpMode {
    ...
    public void buildPaths() {
        ...
        Path4 = follower.pathBuilder()
                .addPath(new BezierCurve(
                        new Pose(50.393, 84.000).mirror(),
                        new Pose(59.665, 55.939).mirror(),
                        new Pose(12.430, 59.710).mirror()
                ))
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
        ...
        Path6 = follower.pathBuilder()
                .addPath(new BezierCurve(
                        new Pose(50.495, 84.103).mirror(),
                        new Pose(65.919, 29.152).mirror(),
                        new Pose(12.308, 35.449).mirror()
                ))
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
