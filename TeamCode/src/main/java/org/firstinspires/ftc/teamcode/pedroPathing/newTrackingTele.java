...
import org.firstinspires.ftc.teamcode.pedroPathing.Subsystems.TurretLocation;
...
@Configurable
@TeleOp(name = "NEW TRACKING TELE")
public class newTrackingTele extends OpMode {
    public static double initialTurretPosition = 0;
    private Follower follower;

    private static final Pose DEFAULT_POSE =
            new Pose(63.213994728013425, 8.52336448598131, Math.toRadians(90));
...
//        boolean trackingEnabled = (gamepad2.left_trigger > 0.5 || gamepad2.right_trigger > 0.5 || gamepad1.left_trigger >0.5 || gamepad1.right_trigger > 0.5);
        ...
        turret.aim(robotPose, Alliance.RED);
        turret.update();
